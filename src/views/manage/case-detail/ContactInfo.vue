<template>
  <a-card class="contact-info">
    <template #title>
      联系信息
      <a-radio-group v-model:value="mode" size="small" button-style="solid" :style="{ marginLeft: '20px' }" @change="radioChange">
    ...
    <BasicTable @register="registerTable" class="pop-table">
      <template #bodyCell="{ column, record }">
        ...
        {{ record.telTimes ? (record.connectedTimes / record.telTimes * 100).toFixed(2) + "%" : null }}
        </template>
